...
- [ ] **Step 2: Implement immutable result contracts**
...
- [ ] **Step 3: Write failing backend integration tests**
...
- [ ] **Step 4: Run the backend tests and verify missing modules fail**
...
- [ ] **Step 5: Implement the Torx adapter's state-vector execution**
...
- [ ] **Step 6: Implement diagnostics, independent comparison, and acceptance**
...
- [ ] **Step 7: Export the backend and run focused regression tests**
...
- [ ] **Step 8: Commit the executable benchmark**
