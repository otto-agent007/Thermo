...
| M4B: matched-training-budget comparison | Active: predeclared protocol | Compare five finite-K4 and equilibrium-directed updates from identical archived initial parameters, using equal trajectory/update budgets and fresh K4 final comparisons. Measure occupancy loss and leakage; do not infer equal hardware cost or inference-sample savings. |
...
The September 12 research decision inserts the bounded
[M4B comparison](experiments/matched-training-budget.md) before M5. This tests
