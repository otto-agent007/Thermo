...
Local browser tests use temporary proposal records on strict port 5174; static
snapshot tests use port 5176. Both preserve the development preview on 5173. Screenshots are written
